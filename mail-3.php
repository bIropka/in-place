...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['name-3'])) {$name = $_POST['name-3'];}
    if (isset($_POST['phone-3'])) {$phone = $_POST['phone-3'];}
    ...
    $subject = "$formData";
    $message = "$formData <br><b>Клиент хочет заказать расчет (Форма 3)</b> <br> <b>Имя клиента:</b> $name <br><b>Телефон:</b> $phone ";
